...
<body>
	<form action="regFormProc.jsp" name="form" method="post">
		<table width="900" height="650">
			...
			<tr>
				<td height="60%" align="center" valign="top">
					...
					<p align="left" style="padding-left: 160px">
						<b>개인정보입력</b> <br> <br> ID : <input type="text"
							size="10" maxlength="15" name="id">&nbsp;<input
							type="button" value="중복 체크" onclick="idcheck()" /><br>
						&nbsp; <br> 비밀번호 : <input type="password" size="15"
							maxlength="20" name="pass"><br> <br> 비밀번호 확인 :
						<input type="password" size="15" maxlength="20" name="pass2"
							onblur="passchk()">&nbsp; <input type="text"
							style="border-width: 0px" size="20" name="chk"
							value="비밀번호를 입력하세요" readonly="readonly" class="danger1">
						<br> <br> 이름 : <input type="text" size="13"
							maxlength="12" name="name"><br> <br> 이메일 : <input
							type="text" size="15" name="email1">@<input type="text"
							size="15" name="email2"><br> <br> 이메일 수신여부 : <input
							type="radio" name="sent" value="ok" checked="checked">
						수신함&nbsp;&nbsp; <input type="radio" name="sent" value="no">
						수신거절<br> <br> 휴대폰 : <span class="selectph1"><select
							name="ph1">
						...
						</select></span> - <input type="text" name="ph2" size="5" maxlength="4"> -
						...
						<br> 성별 : <input type="radio" name="gender" value="남자"
							...
							name="gender" value="여자"> 여자<br> <br> 생년월일 : <select
							name="birth1">
							<%
					...
					<p align="left">
						<span class="danger2"> *주소는 (시/도)만 입력해주세요 (예: 경기도, 서울특별시,
							경상남도 등) </span>
					</p>
				</td>
			</tr>
			<tr>
				<td align="center">
					<hr> <br> <input type="button" value="가입신청"
					onclick="regChk()" />&nbsp; <input type="button" value="다시입력"
					onclick="javascript:location.href='regFormImpl2.jsp" />&nbsp; <input
